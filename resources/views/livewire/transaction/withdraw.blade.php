                    ...
                    <div class="table-responsive">
                        <ul class="responsive-table p-0">
                            <li class="table-header font-weight-bold">
                                ...
                                <div class="col ">Recipient No. </div>
                            ...
                            <li class="table-row">
                                ...
                                <div class="col "><span>0712456109 </span></div>
                                <div class="col "><span>07523456765 </span></div>
                                <div class="col "><span>UGX 100,000.00 </span></div>
                                <div class="col "><span>UGX 20,000.00 </span></div>
                                <div class="col "><span>11300411 </span></div>
                                <div class="col text-center"><span class="status status-success">Successful </span></div>
                            </li>
                            @php
                                    }
                                @endphp
